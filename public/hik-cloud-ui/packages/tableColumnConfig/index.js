...
var script$3 = {
    ...
    components: {
        customConfig: __vue_component__$4
    },
    mixins: [
        Locale
    ],
...
var script$1 = {
    ...
    components: {
        customGroupConfig: __vue_component__$2
    },
    mixins: [
        Locale
    ],
...
//
var script = {
    name: 'HikCloudTableColumnConfig',
    components: {
        customTableConfig: __vue_component__$3,
        customGroupTableConfig: __vue_component__$1
    },
    props: {
        type: {
            type: String,
    ...
    methods: {
        reset () {
            this.$refs.config && this.$refs.config.reset();
        }
    }
};
...
/* template */ var __vue_render__ = function() {
    ...
    var _h = _vm.$createElement;
    var _c = _vm._self._c || _h;
    return _vm.type == 'common' ? _c('customTableConfig', _vm._g(_vm._b({
        ref: "config"
    }, 'customTableConfig', _vm.$attrs, false), _vm.$listeners)) : _c('customGroupTableConfig', _vm._g(_vm._b({}, 'customGroupTableConfig', _vm.$attrs, false), _vm.$listeners));
};
