...
var CosUploader = /*#__PURE__*/function () {
  function CosUploader() {
    _rollupPluginBabelHelpers._classCallCheck(this, CosUploader);
   ...
   * 全局配置
   */
  return _rollupPluginBabelHelpers._createClass(CosUploader, [{
    key: "upload",
    value: (
    /**
     * 上传单个文件
     ...
     */
    function () {
      var _upload = _rollupPluginBabelHelpers._asyncToGenerator(/*#__PURE__*/_rollupPluginBabelHelpers._regenerator().m(function _callee(file, bizCode) {
        var options,
          normalizedFile,
          checkName,
          checkType,
            ...
            case 8:
              ...
              return _context.a(2, new Promise(function (resolve, reject) {
                ...
                client.uploadFile({
                  ...
                  resolve(_rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, data), {}, {
                    fileName: fileName,
                    url: finalUrl,
                    originUrl: finalUrl,
                    stsData: stsData
    ...
    key: "uploadMultiple",
    value: (function () {
      var _uploadMultiple = _rollupPluginBabelHelpers._asyncToGenerator(/*#__PURE__*/_rollupPluginBabelHelpers._regenerator().m(function _callee2(files, bizCode) {
        var _this = this;
        var options,
          promises,
          _args2 = arguments;
